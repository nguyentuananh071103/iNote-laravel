        ...
        <div class="table-responsive">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <tr>
                        <th>User_id</th>
                        <td><input style="width: 90%" type="text" name="user_id" value="{{$note->user_id}}"></td>
                    </tr>
                    <tr>
                        <th>Category_id</th>
                    ...
                    <tr>
                        <th>Description</th>
                        <td><input style="width: 90%" type="text" name="description" value="{{$note->description}}"></td>
                    </tr>
                    <tr>
                        <th>Image</th>
                    ...
                    <tr>
                        ...
                        <button class="text-white" style="background-color: mediumseagreen" type="submit">Save</button>
                    </tr>
                </table>
            </form>
        </div>
